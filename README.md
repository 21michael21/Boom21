...
Реализация системы  начинается с ER-диаграммы создаются классы. К примеру представлен класс "Агент по недвижимости".(см. Листинг 1)
...
<p align="center">Рисунок 6 -Проверка работы метода Create </p>
  ...
  Изменения представлены на рисунке 7.
