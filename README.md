...
# Заключение
 В результате реализации проекта "Система учета агентство недвижимости", решены следущие задачи: систематизация учета недвижимости, основа сайта с информацией о учете недвижимости. Также были получены новые навыки по созданию веб-сайта и основных операций CRUD. Данная информационная система выполняет функции создания, чтения, редактирования и удаления записей. Это система актуальна и перспективна для дальнейшей разработки, в дальнейшем ее ожидает великое будущие.
